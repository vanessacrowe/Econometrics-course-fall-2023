...
#Comparison
#minumum and maximum ages are the same among all genders but the differences between the quartiles was clear
...
#the mean for transgender surveyees was the only mean that was not an exact match to the summary but it
...
##All of the amounts, no matter the kids ages had similarly answered "very stressed about price changes"
#The similarities under all the answers were interesting because I initially though houseolds with younger
...
#the 'south' and the 'west' regions had the more 'no's' long covid and hadcovid but they also had the
#most for "had symotoms 3mo ir more" / "yes tested + or doc told me had covid." This could be 
#if the majority of the residents surveyered were in those regions so the data will always be skewed 
...
#I was most urious about the expeiences of longcovid and the region was a new way to understand. I noticed
#that the amound of people who had covid comparedd to those who clicked they had long covid, had similar ratios 
#no matter where